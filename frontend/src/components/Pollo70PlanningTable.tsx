/**
 * T011 - Pianificazione Nascite Pollo 70
 * Dynamic client columns with sex type selection (like T012/T013)
 */
...
interface Pollo70PlanningTableProps {
...
export default function Pollo70PlanningTable(_props: Pollo70PlanningTableProps) {
    ...
    const fetchSettings = async () => {
        try {
            const res = await fetch(`${API_BASE}/api/settings/planning-table/T011`);
    ...
    const handleToggleSexSplit = async () => {
        ...
        try {
            await fetch(`${API_BASE}/api/settings/planning-table/T011`, {
                method: "PUT",
    ...
    const fetchData = async () => {
        try {
            const res = await fetch(`${API_BASE}/api/chick-planning/pollo70-extended`);
            const json = await res.json();
            setData(json.data || []);
    ...
    const handleAddClient = async () => {
        ...
        try {
            await fetch(`${API_BASE}/api/chick-planning/pollo70/clients`, {
                method: "POST",
                headers: { "Content-Type": "application/json" },
                body: JSON.stringify({
    ...
    const handleDeleteClient = async (clientId: number) => {
        try {
            await fetch(`${API_BASE}/api/chick-planning/pollo70/clients/${clientId}`, {
                method: "DELETE"
            });
    ...
    const handleCellSave = async () => {
        ...
        try {
            await fetch(`${API_BASE}/api/chick-planning/pollo70/client-data`, {
                method: "PUT",
                headers: { "Content-Type": "application/json" },
                body: JSON.stringify({
    ...
    return (
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            {/* Header */}
            <div className="p-4 border-b border-gray-100 bg-pollo70-bright flex items-center justify-between">
                <div>
                    <h2 className="text-xl font-bold text-white">Pianificazione Nascite - Pollo 70</h2>
                    <p className="text-xs text-yellow-100">T011</p>
                </div>
                <div className="flex items-center gap-4">
                    ...
                    <button
                        ...
                        className="px-4 py-2 bg-white text-pollo70-bright rounded-lg hover:bg-gray-100 transition-colors font-medium"
                    >
                        + Aggiungi Cliente
                    </button>
                </div>
                    ...
                    <div className="bg-white rounded-xl p-6 w-96 shadow-xl">
                        ...
                        <div className="flex gap-3 mt-6">
                            ...
                            <button
                                ...
                                className="flex-1 px-4 py-2 bg-pollo70-bright text-white rounded-lg hover:bg-yellow-600"
                            >
                                Aggiungi
                            </button>
                        </div>
